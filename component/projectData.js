const ProjectData = [
  ...
  {
    name: "DISMOVIES",
    info: "Discover and get recommendation of movies.",
  ...
  {
    name: "Hot&Cold",
    info: "It's a weather app to show weather forecast for the next 5days.",
  ...
  },
  {
    ...
    info: "Fast and easy covid19 stats for india with fast search.",
  ...
  {
    name: "Flex Gallery",
    info: "A gallery app with quotes and animations",
  ...
  },
  {
    ...
    info: "Generate beautiful gradients with css code.",
  ...
  },
  {
    ...
    info: "Simple Clock created with vanila javascript.",
  ...
  {
    name: "Drumkit",
    info: "A simple drumkit app created with vanila javascript.",
